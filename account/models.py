...
class User(AbstractUser):
    # TODO:: Rename username field to mobile
    # username (django user): Required. 150 characters or fewer. Usernames may contain alphanumeric, _, @, +, . and - characters.
    # first_name (django user): Optional (blank=True). 30 characters or fewer.
    # last_name (django user): Optional (blank=True). 150 characters or fewer.
    # password (django user): Required. A hash of, and metadata about, the password.
